...
const Footer = () => {
  ...
  return (
    <footer className="relative overflow-hidden w-full bg-gradient-to-b from-black/95 to-dark-blue-700/95 flex flex-col justify-between items-center h-auto mx-auto  md:h-[750px] md:overflow-hidden no-scrollbar">
      <StarsBackground />
      <ShootingStars />
      <Image
        src={astro}
