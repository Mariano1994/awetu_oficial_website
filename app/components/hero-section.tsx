...
const HeroSection = () => {
  return (
    <div className="h-screen w-full bg-gradient-to-tr from-dark-blue-700 to-light-blue-200">
      <Image src={figure1} alt="figure one" className="absolute top-48 h-36" />
      <Image src={figure2} alt="figure one" className="absolute top-64 h-24" />
      <Image
        src={figure3}
        alt="figure one"
      ...
      <div className=" max-w-[1220px]  h-screen mx-auto">
        ...
        <Image src={dashboardIllustratioin} alt="dashboard illustration" />
      </div>
    </div>
  );
};
